...
import { ShoppingBag, Settings, Menu, X, ChevronDown, Sparkles, Home, Layers, Heart, Truck } from 'lucide-react';
...
interface NavbarProps {
  ...
  isAdminMode: boolean;
  selectedGender: 'all' | 'men' | 'women' | 'sale';
  onSelectGender: (gender: 'all' | 'men' | 'women' | 'sale') => void;
...
export default function Navbar({
  ...
  const handleCollectionSelect = (gender: 'all' | 'men' | 'women' | 'sale', category: string) => {
    ...
    <>
      <header className={`fixed left-0 right-0 z-50 w-full transition-all duration-300 border-b ${
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-20 flex items-center justify-between">
          ...
          <div className="hidden md:flex h-full items-center space-x-8 text-[11px] font-black tracking-[0.2em] uppercase">
            <button
              onClick={() => handleCollectionSelect('all', 'All')}
              className={`transition-colors uppercase tracking-[0.25em] h-full flex items-center ${
                isScrolled 
            ...
            <div className="h-full flex items-center relative">
              <button
                onClick={() => handleCollectionSelect('sale', 'All')}
                className={`flex items-center gap-1 transition-all uppercase tracking-[0.25em] cursor-pointer font-bold ${
                  selectedGender === 'sale' 
                    ? 'text-red-500' 
                    : isScrolled 
        ...
        {activeMegaMenu && (
          <div 
            ...
            onMouseLeave={() => setActiveMegaMenu(null)}
            className="absolute top-20 left-0 right-0 border-b shadow-xl transition-all duration-300 p-8 z-40 max-w-7xl mx-auto flex gap-12 font-sans bg-white border-neutral-200 text-neutral-900"
          >
            {/* Column 1: Sub categories link */}
            <div className="flex-1 space-y-4">
              <span className="text-[10px] uppercase tracking-widest font-mono font-bold border-b pb-2 block text-neutral-450 border-neutral-100">
              ...
              <div className="grid grid-cols-2 gap-x-6 gap-y-3 text-left">
                <button 
                  ...
                  className="text-xs font-extrabold transition-colors flex items-center gap-1.5 uppercase tracking-wide group text-neutral-650 hover:text-black"
                >
                ...
                <button 
                  ...
                  className="text-xs font-semibold transition-colors flex items-center gap-1.5 uppercase text-neutral-600 hover:text-black"
                >
                  Signature Line
                </button>
                <button 
      ...
      {isMobileMenuOpen && (
        <div className="fixed inset-0 bg-black/85 backdrop-blur-md z-100 flex justify-start animate-fade-in font-sans">
          <div className={`w-4/5 max-w-sm h-full flex flex-col p-6 space-y-6 relative shadow-2xl overflow-y-auto border-r transition-all duration-300 bg-white border-neutral-100 text-neutral-900`}>
            ...
            <div className="flex justify-between items-center border-b pb-4 border-neutral-100">
              <div className="flex flex-col items-start gap-0.5">
                ...
                <span className="text-[7px] tracking-[0.3em] font-mono block uppercase text-neutral-400">COLOMBO LABEL</span>
              </div>
              <button 
                onClick={() => setIsMobileMenuOpen(false)}
                className="p-1 rounded-full cursor-pointer border bg-neutral-50 hover:bg-neutral-100 border-neutral-100 text-neutral-700"
            ...
            <div className="flex-grow space-y-6">
              ...
              <button
                ...
                className="w-full py-2.5 text-left text-xs font-black tracking-widest uppercase flex items-center gap-2.5 border-b hover:text-amber-500 border-neutral-50 text-neutral-900"
              >
              ...
              <div className="space-y-2 border-b pb-3 border-neutral-100">
                <button
                  ...
                  className="w-full flex justify-between items-center py-2 text-xs font-black tracking-[0.15em] uppercase text-left hover:text-amber-500 text-neutral-900"
                >
                ...
                {activeMobileGender === 'men' && (
                  <div className="pl-6 space-y-2.5 flex flex-col text-left py-1 animate-fade-in">
                    <button 
                      onClick={() => handleCollectionSelect('men', 'All')}
                      className="text-xs font-bold uppercase tracking-wide flex items-center gap-1.5 text-neutral-800 hover:text-black"
                    >
                      <Sparkles className="w-3.5 h-3.5 text-amber-500" /> Show All Mens
                    </button>
                    <button onClick={() => handleCollectionSelect('men', 'Signature')} className="text-xs uppercase text-neutral-500 hover:text-black">Signature Line</button>
                    <button onClick={() => handleCollectionSelect('men', 'Essentials')} className="text-xs uppercase text-neutral-500 hover:text-black">Essentials range</button>
                    <button onClick={() => handleCollectionSelect('men', 'Limited')} className="text-xs uppercase text-neutral-500 hover:text-black">Limited Drop</button>
                  </div>
                )}
              </div>
              ...
              <div className="space-y-2 border-b pb-3 border-neutral-100">
                ...
                {activeMobileGender === 'women' && (
                  <div className="pl-6 space-y-2.5 flex flex-col text-left py-1 animate-fade-in">
                    ...
                    <button onClick={() => handleCollectionSelect('women', 'Signature')} className="text-xs uppercase text-neutral-500 hover:text-black">Signature Line</button>
                    <button onClick={() => handleCollectionSelect('women', 'Essentials')} className="text-xs uppercase text-neutral-500 hover:text-black">Essentials range</button>
                    <button onClick={() => handleCollectionSelect('women', 'Limited')} className="text-xs uppercase text-neutral-500 hover:text-black">Limited Drop</button>
                  </div>
                )}
              </div>
              ...
              <div className="space-y-2 border-b pb-3 border-neutral-100">
                <button
                  onClick={() => {
                    handleCollectionSelect('sale', 'All');
                  }}
                  className="w-full flex justify-between items-center py-2 text-xs font-black tracking-[0.15em] uppercase text-left hover:text-red-500 text-red-600"
                >
                  <span className="flex items-center gap-2">
              ...
              <button
                onClick={() => handleCollectionSelect('all', 'All')}
                className="w-full py-2 text-left text-xs font-black tracking-widest uppercase flex items-center gap-2.5 hover:text-amber-500 text-neutral-600"
              >
              ...
              <div className="pt-4 border-t space-y-4 border-neutral-100">
                ...
                {onOpenOrderTracker && (
                  <button
                    ...
                    className="w-full py-2.5 rounded text-[10px] font-black tracking-widest uppercase border flex items-center justify-center gap-2 transition-all cursor-pointer mb-2 bg-neutral-50 border-neutral-200 text-neutral-700 hover:bg-neutral-100 hover:text-black"
                ...
                <button
                  ...
                  className="w-full py-2.5 rounded text-[10px] font-black tracking-widest uppercase border flex items-center justify-center gap-2 transition-all cursor-pointer bg-neutral-50 border-neutral-200 text-neutral-700 hover:bg-neutral-100 hover:text-black"
                >
            ...
            <div className="border-t pt-4 space-y-4 text-center border-neutral-100">
              ...
              <div className="flex justify-center gap-4 py-1">
                <a
                  ...
                  className="p-2 rounded-full border transition-all duration-300 border-neutral-200 bg-neutral-50 text-neutral-600 hover:text-black hover:border-black"
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="p-2.5 rounded-full border transition-all duration-300 border-neutral-200 bg-neutral-50 text-neutral-600 hover:text-black hover:border-black"
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="p-2 rounded-full border transition-all duration-355 border-neutral-200 bg-neutral-50 text-neutral-600 hover:text-black hover:border-black"
