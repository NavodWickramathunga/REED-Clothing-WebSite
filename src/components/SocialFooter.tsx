...
export default function SocialFooter() {
  const socials = [
    ...
    },
    {
      ...
      hoverColor: 'hover:text-cyan-600 hover:border-cyan-600',
    },
    {
      id: 'facebook',
      name: 'Facebook',
  ...
  return (
    <div className="flex flex-col items-center justify-center space-y-4 py-4" id="social-footer-container">
      <span className="text-[8px] uppercase tracking-[0.3em] font-mono text-neutral-500 block font-bold">
      ...
      <div className="flex items-center justify-center gap-3.5 sm:gap-4">
        {socials.map((social) => (
          <a
            ...
            className={`group flex items-center gap-2 px-5 py-2.5 rounded-full border border-neutral-300 text-neutral-900 bg-white font-mono text-[10px] sm:text-[11px] font-extrabold tracking-[0.16em] uppercase shadow-sm transition-all duration-200 hover:-translate-y-0.5 hover:scale-[1.03] active:scale-95 ${social.hoverColor}`}
