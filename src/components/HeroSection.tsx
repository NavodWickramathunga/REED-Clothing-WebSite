...
export default function HeroSection({ onExploreClick, onSelectCategory, onSelectGender }: HeroSectionProps) {
  ...
  return (
    ...
    >
      {/* 📹 Looping Cinematic Workout/Athletic Background Video */}
      <div className="absolute inset-0 w-full h-full z-0 overflow-hidden">
        <video 
          ...
          poster="https://images.unsplash.com/photo-1548690312-e3b507d8c110?w=1600&auto=format&fit=crop&q=80"
        >
          {/* Locally-hosted high fidelity MP4 workout loop - extremely polished, reliable, zero CORS restrictions */}
          <source 
            src="/reed-hero.mp4" 
            type="video/mp4" 
          />
          {/* Fallback Mixkit direct link */}
          <source 
            src="https://assets.mixkit.co/videos/preview/mixkit-man-training-with-battle-ropes-at-the-gym-42249-large.mp4" 
            type="video/mp4" 
          />
          <source 
            src="https://assets.mixkit.co/videos/preview/mixkit-woman-doing-athletic-training-in-a-gym-42245-large.mp4" 
            type="video/mp4" 
          />
        </video>
